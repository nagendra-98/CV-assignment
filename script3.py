...
import cv2
img4 = cv2.imread("C:\\Users\\Nagendra\\Desktop\\Images folder.py\\internship-assignment-cv\\Dataset\\2.Sample-img2\\OUTPUT_partially_annotated_image.jpg",1)
img4 = cv2.resize(img4, (900, 900))
cv2.imshow("Colored image", img4)
cv2.waitKey(8000)
...
cv2.fillPoly(img4.jpg, [350, 350, 700, 900], (0, 0, 0))
cv2.imwrite("C:\\Users\\Nagendra\\Desktop\\Images folder.py\\imgs\\Processed Images", img4.jpg)
cv2.imshow('converted image==', img4.jpg)
k = cv2.waitKey(0) & 0xFF
if k == ord("q"):
    cv2.destroyAllWindows()
elif k == ord("s"):
    cv2.imwrite("output.png", img4.jpg)
    cv2.waitkey(6000)
    cv2.destroyAllWindows
